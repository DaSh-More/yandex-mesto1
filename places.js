...
const _showAddPlacePopupButton = document.querySelector(
    "button.user-info__button_type_new-place"
);

const _validationHelper = initValidation(
    _addPlaceForm,
    _addPlacePopup.submitButton
);
